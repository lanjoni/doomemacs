...
- [[https://crystal-lang.org/install/][The Crystal compiler and REPL]]
...
** ICR (REPL)
Currently ICR is compiled together with Crystal and can be used easily with the command: ~$ crystal i~
